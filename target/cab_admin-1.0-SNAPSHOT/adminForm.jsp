    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Sign Up Form -->
                <form action="ManageAdminServlet" method="post" id="adminForm">
                    <input type="hidden" name="action" id="formAction" value="addAdmin">
                    <input type="hidden" name="adminId" id="signup-id">
                    ...
                    <button type="submit" class="btn btn-primary w-100" id="formSubmitButton">Add Admin</button>
                </form>
            </div>
        </div>
    </div>
