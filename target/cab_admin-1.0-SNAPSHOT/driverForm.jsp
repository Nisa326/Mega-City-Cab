    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="formModalLabel">Add Driver</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <!-- Driver Registration Form -->
                <form action="ManageDriverServlet" method="post" id="driverForm">
                    <input type="hidden" name="action" id="formAction" value="addDriver">
                    <input type="hidden" name="driverId" id="signup-id">
                    ...
                    <div class="mb-3">
                        <label for="signup-license" class="form-label">Driver's License Number</label>
                        <input type="text" class="form-control" name="license" id="signup-license" required>
                    </div>
                    <div class="mb-3">
                        <label for="signup-year" class="form-label">Driver's Year of Experience</label>
                        <input type="text" class="form-control" name="year" id="signup-year" required>
                    </div>
                    <div class="mb-3">
                        <label for="signup-created" class="form-label">Join Date</label>
                        <input type="date" class="form-control" name="created" id="signup-created" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-primary w-100" id="formSubmitButton">Add Driver</button>
                </form>
            </div>
        </div>
    </div>
